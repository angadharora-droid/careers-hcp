/* Centre Point Amravati interview panel, transcribed from CPA_Job_Catalogue.xlsx.
   ...
   holding "A/B/C" means any of those people may take that panel â€” the first becomes
...
/* Sheet name â†’ the name stored on the account, where the two differ.
...
export const NAME_ALIASES = {
  ...
  'Rajkumar Gudankwar': 'Rajkumar',    // seeded first-name-only, HR â€” Units
