// Single stroke family (Lucide-style) — 24x24 viewBox, currentColor, no fills.
// Decorative usages stay aria-hidden (default); icon-only buttons carry aria-label.
function Icon({ size = 16, className = '', label, children }) {
  return (
    <svg
      width={size}
      height={size}
